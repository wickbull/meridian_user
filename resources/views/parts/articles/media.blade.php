<article class="c-news-item c-news-item--media">
    <a href="{{ $item->getViewUrl() }}" class="link">

        <div class="js-img c-img c-img--lg">
            <img src="{{ $item->getImage('720x450', 'default') }}" srcset="{{ $item->getImage('1440x900', 'default') }} 2x" alt="{{ $item->title }}" width="720" height="450">
        </div>
