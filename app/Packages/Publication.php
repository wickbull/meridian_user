...
class Publication extends Model {
     ...
     * @var string
     */
    public $translationModel = '\Packages\PublicationTranslation';
    ...
    {
        return $query->orderBy('publications.publish_at', 'DESC');
    }
    ...
    {
        return $query->active()
            ->where(\DB::raw('`publications`.publish_at'), '<', Carbon::now())
            ->translatedIn('uk');
    }
    ...
    {
        return route('publications.view', $this->slug);
    }
    ...
    {
        return $this->belongsToMany('Packages\PublicationsCategory', 'publication_publications_category');
    }
    ...
    {
        return GenericFileAttachment::makePrimaryKey('Packages\Publication', $this->id, 'image_storage_id');
    }
    ...
    public function getImage($size = false, $placeholder = 'default')
    {
        ...
        switch ($placeholder) {
            case 'default':
                return static_asset('/src/img/logo-default.jpg');
            case 'square':
                return static_asset('/src/img/logo-square.jpg');
            case 'OG':
                return static_asset('/src/img/og.jpg');
            default:
                return static_asset('/src/img/logo.png');
        }
    }
